...
public enum ReefSide {
    SIDE_AB(
            new Pose2d(
                    Units.inchesToMeters(144.003), Units.inchesToMeters(158.500), Rotation2d.kZero),
            new Pose2d(
                    Units.inchesToMeters(546.873), Units.inchesToMeters(158.5), Rotation2d.k180deg),
            ReefPipe.PIPE_A,
            ReefPipe.PIPE_B,
            ReefPipeLevel.L3,
            7,
    ...
    SIDE_GH(
            new Pose2d(
                    ...
                    Rotation2d.k180deg),
            new Pose2d(
                    Units.inchesToMeters(481.387), Units.inchesToMeters(158.498), Rotation2d.kZero),
            ReefPipe.PIPE_G,
            ReefPipe.PIPE_H,
            ReefPipeLevel.L2,
            10,
    ...
    SIDE_IJ(
            new Pose2d(
                    ...
                    Rotation2d.fromDegrees(240)),
            new Pose2d(
                    Units.inchesToMeters(497.76),
                    Units.inchesToMeters(130.142),
                    Rotation2d.fromDegrees(60)),
            ReefPipe.PIPE_I,
            ReefPipe.PIPE_J,
            ReefPipeLevel.L3,
    ...
    public Pose2d getPose(ReefSideOffset offset, RobotScoringSide scoringSide, Pose2d robotPose) {
        return getPose(robotPose)
                .transformBy(
                        (scoringSide.equals(RobotScoringSide.LEFT)
                                ? offset.leftOffset
                                : offset.rightOffset));
    }
