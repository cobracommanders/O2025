...
public class AutoBlocks {
    ...
    public static final PoseErrorTolerance APPROACH_REEF_TOLERANCE =
            new PoseErrorTolerance(0.4, 10);
    ...
    public Transform2d clearReefOffset =
            new Transform2d(new Translation2d(0.4, -1), Rotation2d.kZero);

    public static final Transform2d RIGHT_LOLLIPOP_OFFSET =
            new Transform2d(
                    0.0,
                    Units.inchesToMeters(ArmConstants.inchesFromCenter - 4.5),
                    Rotation2d.fromDegrees(-90));
    public static final Transform2d LEFT_LOLLIPOP_OFFSET =
            new Transform2d(
                    0.0,
                    Units.inchesToMeters(ArmConstants.inchesFromCenter),
                    Rotation2d.fromDegrees(-90));
    public static final Transform2d CENTER_LOLLIPOP_OFFSET =
            new Transform2d(
                    0.0,
    ...
    public static final AutoConstraintOptions BASE_CONSTRAINTS =
            new AutoConstraintOptions(4.75, 30, 1.25, 25);
    ...
    private static final AutoConstraintOptions SCORING_CONSTRAINTS =
            BASE_CONSTRAINTS.withMaxLinearVelocity(2);
    ...
    private static final AutoConstraintOptions SCORING_CONSTRAINTS_FOR_GROUND_AUTOS =
            BASE_CONSTRAINTS_FOR_GROUND_AUTOS
                    .withMaxLinearAcceleration(1.25)
                    .withMaxLinearVelocity(3);
    ...
    public Command scoreL2(ReefPipe pipe, RobotScoringSide scoringSide) {
        return Commands.sequence(
                ...
                trailblazer
                        ...
                        // Moves the arm in parallel, the group won't move on until this command
                        // finishes and the arm is ready
                        .alongWith(
                                requestManager.prepareCoralScoreAndAwaitReady(
                                        FieldConstants.PipeScoringLevel.L2)),
    ...
    public Command scoreL4(ReefPipe pipe, RobotScoringSide scoringSide) {
        return Commands.sequence(
                ...
                trailblazer
                        ...
                        .alongWith(
                                requestManager.prepareCoralScoreAndAwaitReady(
                                        FieldConstants.PipeScoringLevel.L4)),
                requestManager.executeCoralScoreAndAwaitComplete());
    }
        ...
        return Commands.sequence(
                ...
                trailblazer.followSegment(
                        new AutoSegment(
                                ...
                                AutoBlocks.APPROACH_REEF_TOLERANCE,
                                new AutoPoint(
                                        new Pose2d(12.836, 1.085, Rotation2d.fromDegrees(90.0))),
                                new AutoPoint(
                                        new Pose2d(14.644, 2.240, Rotation2d.fromDegrees(90.0))))));
    }
        ...
        return Commands.sequence(
                ...
                trailblazer.followSegment(
                        new AutoSegment(
                                ...
                                AutoBlocks.APPROACH_REEF_TOLERANCE,
                                new AutoPoint(
                                        new Pose2d(12.836, 6.965, Rotation2d.fromDegrees(90))),
                                new AutoPoint(
                                        new Pose2d(14.644, 5.81, Rotation2d.fromDegrees(90))))));
    }
        ...
        return Commands.sequence(
                ...
                trailblazer.followSegment(
                        new AutoSegment(
                                ...
                                AutoBlocks.APPROACH_REEF_TOLERANCE,
                                new AutoPoint(
                                        new Pose2d(4.714, 6.965, Rotation2d.fromDegrees(-90))),
                                new AutoPoint(
                                        new Pose2d(2.906, 5.81, Rotation2d.fromDegrees(-90))))));
    }
        ...
        return Commands.sequence(
                ...
                trailblazer.followSegment(
                        new AutoSegment(
                                ...
                                AutoBlocks.APPROACH_REEF_TOLERANCE,
                                new AutoPoint(
                                        new Pose2d(4.714, 1.085, Rotation2d.fromDegrees(-90))),
                                new AutoPoint(
                                        new Pose2d(2.906, 2.24, Rotation2d.fromDegrees(-90))))));
    }
