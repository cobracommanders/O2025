...
public class RequestManager {
    ...
    public Command climbRequest() {
        return Commands.parallel(groundCommands.requestClimbAndAwaitReady(), armCommands.requestClimbAndAwaitReady(), climber.runOnce(() -> climber.setState(ClimberStates.DEPLOYING)));
    }
