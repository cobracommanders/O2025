...
public class ArmPositions {
    ...
    public static final double ALGAE_NET = 0.17;
    public static final double L4 = 0.1;
    public static final double SCORE_L4 = -0.0025;
    ...
    public static final double L3 = 0.08;
    public static final double SCORE_L3 = 0.0;
