...
public class SimArm {
    ...
    private static SingleJointedArmSim armSim = new SingleJointedArmSim(
            ...
            armLength,
            Units.rotationsToRadians(ArmPositions.HANDOFF_LEFT),
    ...
    public static void updateSimPosition(TalonFX motor, CANcoder encoder) {
        ...
        motorSim.setRawRotorPosition(Units.radiansToRotations(armSim.getAngleRads()) * ArmConstants.ArmGearRatio);
        motorSim.setRotorVelocity(Units.radiansToRotations(armSim.getVelocityRadPerSec()) * ArmConstants.ArmGearRatio);
