...
public class Climber extends StateMachine<ClimberStates> {
    ...
    private Climber() {
        ...
        winch_motor_config.MotionMagic.MotionMagicCruiseVelocity =
                ClimberConstants.DEPLOY_MOTION_MAGIC_CRUISE_VELOCITY;
        winch_motor_config.MotionMagic.MotionMagicAcceleration =
                ClimberConstants.DEPLOY_MOTION_MAGIC_ACCELERATION;
    ...
    public boolean atGoal() {
        return switch (getState()) {
            ...
            case WAIT_FOR_CAGE -> cageDetected();
            default -> false;
        };
    }
