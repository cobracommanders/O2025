...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("bus", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12Volts = 5.96;
    ...
    private static final Distance kWheelRadius = Inches.of(1.99);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.129);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.16943359375);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.329833984375);
