 ...
 * @param maxAngularVelocity Max angular velocity allowed in radians per second. Set to 0 to
 *     disable.
 * @param maxLinearAcceleration Max linear acceleration allowed in meters per second squared. Set to
 *     0 to disable.
 * @param maxAngularAcceleration Max angular acceleration allowed in radians per second squared. Set
 *     to 0 to disable.
 */
