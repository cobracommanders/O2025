...
public class MathHelpersDog {
    ...
    public static Translation2d roundTo(Translation2d input, double precision) {
        return new Translation2d(
                roundTo(input.getX(), precision), roundTo(input.getY(), precision));
    }
    ...
    /**
     * Returns the value that is closer from the two given values. If they are equal, the first
     * value is returned.
     */
    ...
    /**
     * Returns the value that is farther from the two given values. If they are equal, the first
     * value is returned.
     */
