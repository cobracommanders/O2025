...
public class VisionSubsystem extends StateMachine<VisionStates> {
    ...
    public VisionSubsystem(Limelight bl, Limelight fl, Limelight right) {
    ...
    protected void collectInputs() {
        //    angularVelocity =
        // Units.radiansToDegrees(DriveSubsystem.getInstance().getFieldRelativeSpeeds().omegaRadiansPerSecond);
    ...
    public OptionalTagResult getGamePieceTagResult() {
        if (leftBackTagResult.isEmpty()
                && rightTagResult.isEmpty()
                && leftFrontTagResult.isEmpty()) {
        ...
        if (instance == null)
            instance =
                    new VisionSubsystem(
                            ...
                            new Limelight(
                                    "right",
                                    LimelightStates.CLOSEST_REEF_TAG,
                                    true)); // Make sure there is an instance (this will only run
        // once)
        return instance;
    }
}
